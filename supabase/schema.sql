...
create table if not exists public.skills (
  ...
  title text not null,
  icon text,
  knowledge_percent int not null default 0,
...
alter table public.skills
  add column if not exists knowledge_percent int not null default 0;

alter table public.education add column if not exists image_url text;
alter table public.experience add column if not exists year_start int;
alter table public.experience add column if not exists year_end int;
